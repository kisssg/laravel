...
Route::get('collector/upload', 'CollectorController@upload')->middleware('auth')->middleware('can:manage collectors');
...
Route::get('training/upload',"OnlineTestController@upload")->middleware('auth');
Route::post('training/import',"OnlineTestController@import")->middleware('auth');
Route::resource('training',"OnlineTestController")->middleware('auth');
