...
class ScoreProject extends Model
{
    ...
    protected $fillable=['name', 'description', 'data_to_score', 'score_save_to','audit_save_to','data_fillable',
        'audit_fillable','score_fillable','data_list_columns','data_list_column_alias','data_to_score_columns','order_by_columns','date_field','contract_no_field','search_columns'];
